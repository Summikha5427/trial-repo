        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4 pl-4">
          ...
          <div>
            <p>I am passionate about building excellent software that improves the lives of those around me.
              I Specialize in creating software for clients ranging from individuals and small-businesses all the way to large co-orpertaions.
              What will you do if you have a softeare expert available at your fingertips?
            </p>
          </div>
        </div>
      </div>
